...
//			String botId = BotId.UNDER_PRODUCTION_VENDOR.name();
		...
		if(value2 > percent2) {
			...
			String btnString = "통보";
			String btnUrl = BlockKitDataParshing.setDefectRateOccurUrl(plant, material, tid, prodDate, firsttimeFailQty, prodQty, percent2);
			//String btnUrl =  "https://www.daum.net/";
			
			String message = BlockKitDataParshing.defectRate(blockKit, btnString, btnUrl, prodDate, materialName, firsttimeFailQty, prodQty, percent2);
...
//			String botId = BotId.UNDER_PRODUCTION_MAIN.name();
	...
	public void notice(WorkDailyReportDTO parent,WorkContents param) throws Exception {
		...
		if(value2 > percent2) {
			...
			String blockKit = blockKitMapper.find(DEFECT_RATE);
			String btnString = "확인";
			String btnUrl = BlockKitDataParshing.setDefectRateNoticeUrl(plant, material, tid, prodDate, firsttimeFailQty, prodQty, percent2);
			//String btnUrl =  "https://www.daum.net/";
