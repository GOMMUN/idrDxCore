...
import com.idr.pdd.service.AnomalydetectConfirmService;
...
@Slf4j
@RestController
@RequestMapping("anomaly-confirm")
@Tag(name = "10. 이상감지확인", description = "ANOMALYDETECT_CONFIRM")
public class AnomalydetectConfirmController {
	

	@Autowired
	private AnomalydetectConfirmService service;

	@ResponseBody
	@PostMapping("/")
	@Operation(summary = "등록", description = "이상감지확인 신규 등록합니다.")
    public ResponseEntity<Message> create(@RequestBody AnomalydetectConfirmDTO param) {
